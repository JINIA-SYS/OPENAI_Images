    ...
    const handleSubmit = async (e) => {
        ...
        if (form.prompt && form.photo) {
            ...
            try {
                ...
                const response = await fetch("http://localhost:8080/api/v1/post/", { method: 'POST', headers: { 'Content-Type': 'application/json' }, body: JSON.stringify(form) })
                await response.json();
                navigate("/")
        ...
        <section className='max-w-7xl mx-auto'>
            ...
            <div>
                ...
                <p className="mt-2 text-[#666e75] text-[20px] max-w-[500px]">
                    ...
                    images through DALL-E AI and share them with community
                </p>
            </div>
            ...
            <form className='mt-16 max-w-3xl' onSubmit={handleSubmit}>
                ...
                <div className='mt-5 flex gap-5 '>
                    <button type="button" onClick={generateImage} className='text-white bg-green-700 font-medium rounded-md text-sm 
